    ...
    const fetchData = async () => {
      try {
        ...
        if (wardClasses.length > 0) {
          try {
            const assignmentsRes = await axios.get('https://bilal.skoolific.com/api/class-teacher/assignments');
        ...
        if (guardianUsername) {
          try {
            const contactsRes = await axios.get(`https://bilal.skoolific.com/api/chats/contacts/guardian/${guardianUsername}`);
        ...
        if (teacherMap.size === 0) {
          try {
            const allContactsRes = await axios.get('https://bilal.skoolific.com/api/chats/contacts');
        ...
        const requestsRes = await axios.get(`https://bilal.skoolific.com/api/chats/user/${guardianId}`);
