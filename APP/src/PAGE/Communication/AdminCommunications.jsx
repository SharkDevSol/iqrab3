  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const requestsRes = await axios.get(`https://iqrab2.skoolific.com/api/chats/user/${adminId}`);
        ...
        try {
          const fallbackRes = await axios.get('https://iqrab2.skoolific.com/api/chats/contacts');
