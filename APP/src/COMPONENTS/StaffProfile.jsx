          ...
          {students.length === 0 ? (
            ...
            <div className={styles.studentsList}>
              {students.map((student, index) => {
                ...
                return (
                  <div key={student.student_id || index} style={{display:'flex',flexDirection:'row',alignItems:'center',justifyContent:'space-between',padding:'0.5rem 0.75rem',background:'#f0f4ff',borderRadius:'12px',border:'1.5px solid #c7d2fe',gap:'0.5rem',marginBottom:'0.5rem'}}>
                    <span style={{fontSize:'0.85rem',fontWeight:600,color:'#1e293b',flex:1,overflow:'hidden',textOverflow:'ellipsis',whiteSpace:'nowrap'}}>{student.student_name}</span>
