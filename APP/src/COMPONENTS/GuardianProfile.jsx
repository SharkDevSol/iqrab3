...
const GuardianProfile = () => {
  ...
  const fetchProfile = useCallback(async () => {
    try {
      ...
      const response = await axios.get(`https://iqrab2.skoolific.com/api/students/guardian-profile/${username}`);
      ...
      const guardiansResponse = await axios.get('https://iqrab2.skoolific.com/api/guardian-list/guardians');
  ...
  const fetchProfilePosts = useCallback(async (schoolId) => {
    try {
      const response = await axios.get(`https://iqrab2.skoolific.com/api/posts/profile/guardian/${schoolId}`);
  ...
  const fetchAllWardsMarks = useCallback(async (guardianUsername) => {
    ...
    try {
      const response = await axios.get(
        `https://iqrab2.skoolific.com/api/mark-list/guardian-marks/${encodeURIComponent(guardianUsername)}`
      );
  ...
  const fetchAttendanceTables = useCallback(async (ward) => {
    ...
    try {
      ...
      const response = await axios.get(
        `https://iqrab2.skoolific.com/api/guardian-student-attendance/student-attendance/${encodeURIComponent(ward.class)}/${ward.school_id}?year=${selectedYear}&month=${selectedMonth}`
      );
  ...
  const fetchWardAttendance = useCallback(async (ward, tableName) => {
    ...
    try {
      ...
      const response = await axios.get(
        `https://iqrab2.skoolific.com/api/guardian-attendance/student/${encodeURIComponent(className)}/${encodeURIComponent(tableName)}/${ward.school_id}`
      );
  ...
  const fetchMonthlySummary = useCallback(async (ward, year, month) => {
    ...
    try {
      ...
      const summaryResponse = await axios.get(
        `https://iqrab2.skoolific.com/api/guardian-student-attendance/monthly-summary/${encodeURIComponent(ward.class)}/${ward.school_id}?year=${year}&month=${month}`
      );
      setMonthlySummary(summaryResponse.data);

      // Fetch daily details
      const dailyResponse = await axios.get(
        `https://iqrab2.skoolific.com/api/guardian-student-attendance/student-attendance/${encodeURIComponent(ward.class)}/${ward.school_id}?year=${year}&month=${month}`
      );
  ...
  const fetchAttendanceTrends = useCallback(async (ward) => {
    ...
    try {
      const response = await axios.get(
        `https://iqrab2.skoolific.com/api/guardian-student-attendance/trends/${encodeURIComponent(ward.class)}/${ward.school_id}`
      );
  ...
  const downloadAttendanceReport = async (ward, year, month) => {
    ...
    try {
      const className = ward.class.replace(/\s+/g, '_');
      const response = await axios.get(
        `https://iqrab2.skoolific.com/api/guardian-attendance/report/${encodeURIComponent(className)}/${ward.school_id}/${year}/${month}`,
        { responseType: 'blob' }
      );
  ...
  const fetchEvalBookEvaluations = useCallback(async (guardianId, wardsList) => {
    ...
    try {
      ...
      const response = await axios.get(
        `https://iqrab2.skoolific.com/api/evaluation-book/daily/guardian/${encodeURIComponent(guardianId)}`
      );
          ...
          if (ward.class && ward.student_name) {
            try {
              const classResponse = await axios.get(
                `https://iqrab2.skoolific.com/api/evaluation-book/daily/class/${encodeURIComponent(ward.class)}`
              );
  ...
  const fetchPaymentData = useCallback(async (guardianUsername) => {
    ...
    try {
      ...
      const response = await axios.get(
        `https://iqrab2.skoolific.com/api/guardian-payments/${encodeURIComponent(guardianUsername)}`
      );
    ...
    try {
      ...
      for (const ward of wards) {
        try {
          ...
          const response = await axios.get(
            `https://iqrab2.skoolific.com/api/guardian-student-attendance/student-attendance/${encodeURIComponent(ward.class)}/${ward.school_id}?year=${ethDate.year}&month=${ethDate.month}`
          );
      ...
      try {
        const paymentResponse = await axios.get(
          `https://iqrab2.skoolific.com/api/guardian-payments/${encodeURIComponent(guardianInfo.guardian_username)}`
        );
  ...
  const submitFeedback = async () => {
    ...
    try {
      await axios.post('https://iqrab2.skoolific.com/api/evaluation-book/feedback', {
  ...
  const handleLike = async (postId) => {
    try {
      await axios.put(`https://iqrab2.skoolific.com/api/posts/${postId}/like`);
        ...
        <div className={styles.wardsSummary}>
          ...
          {wards.map((ward, index) => {
            ...
            const getImageUrl = (imagePath) => {
              ...
              return `https://iqrab2.skoolific.com/uploads/${cleanPath}`;
            };
  ...
  const fetchChatConversations = async (userId) => {
    try {
      const res = await axios.get(`https://iqrab2.skoolific.com/api/chats/conversations?userId=${userId}`);
  ...
  const fetchChatContacts = async () => {
    ...
    try {
      const teachersRes = await axios.get('https://iqrab2.skoolific.com/api/chats/contacts/teachers');
