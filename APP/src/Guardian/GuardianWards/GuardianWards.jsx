              ...
              >
                <div className={styles.wardHeader}>
                  <div className={styles.avatar}>
                    {ward.image_student ? (
                      <img src={`https://iqrab2.skoolific.com/uploads/${ward.image_student}`} alt={ward.student_name} />
                    ) : (
                      <FiUser size={32} />
                    )}
                  </div>
            ...
            <div className={styles.modalBody}>
              <div className={styles.modalAvatar}>
                {selectedWard.image_student ? (
                  <img src={`https://iqrab2.skoolific.com/uploads/${selectedWard.image_student}`} alt={selectedWard.student_name} />
                ) : (
                  <FiUser size={64} />
                )}
              </div>
