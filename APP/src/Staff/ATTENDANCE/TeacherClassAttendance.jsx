...
const TeacherClassAttendance = () => {
  ...
  const fetchAssignedClass = async () => {
    try {
      ...
      const response = await axios.get('https://iqrab3.skoolific.com/api/class-teacher/assignments');
  ...
  const fetchCurrentDate = async () => {
    try {
      const response = await axios.get('https://iqrab3.skoolific.com/api/academic/student-attendance/current-date');
  ...
  const fetchSettings = async () => {
    try {
      const response = await axios.get('https://iqrab3.skoolific.com/api/academic/student-attendance/settings');
      if (response.data.success) {
  ...
  const fetchStudents = async () => {
    try {
      setIsLoading(true);
      const response = await axios.get('https://iqrab3.skoolific.com/api/academic/student-attendance/students', {
  ...
  const generateSchoolWeeks = async () => {
    ...
    while (daysChecked < maxDays && weekNumber <= 52) {
      try {
        const response = await axios.get('https://iqrab3.skoolific.com/api/academic/student-attendance/day-of-week', {
        ...
        if (response.data.success && response.data.data.dayOfWeek === 'Monday') {
          ...
          while (schoolDaysCollected < daysPerWeek && daysScanned < 14) {
            const dayResponse = await axios.get('https://iqrab3.skoolific.com/api/academic/student-attendance/day-of-week', {
  ...
  const fetchAttendance = async () => {
    ...
    try {
      ...
      const promises = selectedWeek.days.map(day =>
        axios.get('https://iqrab3.skoolific.com/api/academic/student-attendance/weekly', {
          params: {
  ...
  const handleSaveAttendance = async () => {
    try {
      ...
      const response = await axios.put('https://iqrab3.skoolific.com/api/academic/student-attendance/update', {
