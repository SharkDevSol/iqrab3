-- ============================================
-- FIXED MERGE: G8A and G8B into G8
-- This script checks actual columns first
-- ============================================
...
-- Step 2: Copy all students from G8B to G8A (using only existing columns)
...
UPDATE finance_schema.monthly_payments SET class = 'G8A' WHERE class = 'G8A';
