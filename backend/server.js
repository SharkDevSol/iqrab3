...
const io = new Server(server, {
  cors: {
    origin: process.env.NODE_ENV === 'production'
      ? [process.env.FRONTEND_URL || 'https://iqrab2.skoolific.com']
      : ['http://localhost:3000', 'http://localhost:5173', 'http://localhost:5022'],
    methods: ['GET', 'POST'],
...
const allowedOrigins = process.env.NODE_ENV === 'production' 
  ? [process.env.FRONTEND_URL || 'https://iqrab2.skoolific.com']  // Production domain
  : ['http://localhost:3000', 'http://localhost:5173', 'http://localhost:5022'];
